/*
  HOME SECTION (One-pager ready)
  - This is the top section of the one-page site
  - id="home" is used for navbar scrolling & active state later
*/
...
export default function Page() {
  return (
    /* SCROLL TARGET */
    <section id="home">
      /*where to add the project section?*/
